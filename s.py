...
bot = telebot.TeleBot('7374686578:AAE7CxSBpccUh5ScYDrIRTYlWy9G6P4vfrY')
...
def generate_key(duration):
    ...
    return f"CAPTAIN-{duration.upper()}-{random_part}"
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 ROY 𝗯𝗼𝘁!", reply_markup=markup)
